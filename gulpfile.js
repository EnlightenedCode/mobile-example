...
gulp.task('connect', connect.server({
        ...
        middleware: function(connectD, options) {
            ...
            return [
                ...
                connectD().use(
                    '/dist',
                    connectD.static('./dist')
                ),
                connectD().use(
                    '/bower_components',
                    connectD.static('./bower_components')
                ),
                connectD().use(
                    '/node_modules',
                    connectD.static('./node_modules')
                ),
                connectD.static(appConfig.app)
            ].concat(
                optBase.map(function (path) {
                    return connectD.static(path);
                }), historyApiFallback({}));
        }
    })
);
